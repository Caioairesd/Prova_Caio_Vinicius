...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($usuario) {
        ...
        echo "<script>alert('Uma senha temporária foi gerada e enviada (simulação). Verifique o arquivo emails_simulados.txt.'); window.location.href='excluir_funcionario.php';</script>";
